...
public interface ControllerParams {
    ...
    public static final Joystick.AxisType LEFT_DRIVE_AXIS_ID = Joystick.AxisType.kY; // Left vertical axis
    public static final Joystick.AxisType RIGHT_DRIVE_AXIS_ID = Joystick.AxisType.kZ; // Right vertical axis
    ...
    public static final Joystick.AxisType MANUAL_SHOOTER_MOVE_AXIS_ID = Joystick.AxisType.kY; // Left vertical axis
